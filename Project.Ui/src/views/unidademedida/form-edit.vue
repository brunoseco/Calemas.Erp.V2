<template>
    ...
    <form ref="unidademedida-form-edit" v-on:submit.prevent="executeEdit(model)" novalidate>
...
<script>
    ...
    export default {
        ...
        mounted() {
            new Api(this.resources.edit).get({ unidadeMedidaId: this.id }).then(data => {
