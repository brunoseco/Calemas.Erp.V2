<template>
    <main class="main">
            ...
            <div class="row animated fadeIn" v-if="dialogFilter">
                <div class="col-sm-12">
					<form v-on:submit.prevent="executeFilter(filter)">
                        ...
                        <input type="text" class="form-control" name="colaboradorId" autocomplete="off" placeholder="ColaboradorId" v-model="filter.colaboradorId"  />
                    </div>
                    <div class="form-group col-md-12">
                        <label for="estoqueMovimentacaoId">EstoqueMovimentacao</label>
                        <select v-select="{ dataitem: 'EstoqueMovimentacao', default: 'Selecione' }" v-model="filter.estoqueMovimentacaoId" class="form-control" name="estoqueMovimentacaoId" ></select>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-hover table-striped">
                                ...
                                <tbody>
                                    <tr v-for="item in result.items" v-bind:key="item.estoqueMovimentacaoColaboradorId" class="animated fadeIn">
                                        <td>{{ item.estoqueMovimentacaoColaboradorId }}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger" v-b-tooltip title="Remover" @click="openRemove({ estoqueMovimentacaoColaboradorId: item.estoqueMovimentacaoColaboradorId })">
        ...
        <b-modal centered v-model="dialogEdit" :hide-footer="true" title="Editar">
            <form-edit v-if="dialogEdit" :id="estoqueMovimentacaoColaboradorId" @on-saved="onSaved()" @on-back="hideAll()" />
        </b-modal>
...
<script>
    ...
    export default {
        name: 'estoquemovimentacaocolaborador',
        mixins: [base],
        ...
        data() {
            return {
                ...
                resources: {
                    filter: 'estoquemovimentacaocolaborador',
                    remove: 'estoquemovimentacaocolaborador'
                },
        ...
        methods: {
            openEdit: function (model) {
                this.estoqueMovimentacaoColaboradorId = model.estoqueMovimentacaoColaboradorId;
