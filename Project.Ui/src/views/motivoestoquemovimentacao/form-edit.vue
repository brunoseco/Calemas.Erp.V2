<template>
    ...
    <form ref="motivoestoquemovimentacao-form-edit" v-on:submit.prevent="executeEdit(model)" novalidate>
...
<script>
    ...
    export default {
        name: "motivoestoquemovimentacao-form-edit",
        mixins: [base],
        props: { id: Number },
        data: () => ({
            ...
            form: "motivoestoquemovimentacao-form-edit",
            
            resources: {
                edit: 'motivoestoquemovimentacao',
            },
        ...
        mounted() {
            new Api(this.resources.edit).get({ motivoEstoqueMovimentacaoId: this.id }).then(data => {
