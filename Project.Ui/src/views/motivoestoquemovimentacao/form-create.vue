<template>
    ...
    <form ref="motivoestoquemovimentacao-form-create" v-on:submit.prevent="executeCreate(model)" novalidate>
...
<script>
    ...
    export default {
        name: "motivoestoquemovimentacao-form-create",
        mixins: [base],
        data: () => ({

            model: {},

            form: "motivoestoquemovimentacao-form-create",
            
            resources: {
                create: 'motivoestoquemovimentacao',
            },
