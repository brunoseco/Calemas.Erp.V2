<template>
    <main class="main">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">Motivo de Movimentação de Estoque</li>
            ...
            <div class="row animated fadeIn">
                <div class="col-xs-12 col-sm-7 col-md-7 col-lg-8">
                    <h6 class="page-title txt-color-blueDark">
                        ...
                        <span>Manutenção de motivo de movimentação de estoque</span>
                    </h6>
                </div>
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-hover table-striped">
                                ...
                                <tbody>
                                    <tr v-for="item in result.items" v-bind:key="item.motivoEstoqueMovimentacaoId" class="animated fadeIn">
                                        <td>{{ item.motivoEstoqueMovimentacaoId }}</td>
                                        <td>{{ item.nome }}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger" v-b-tooltip title="Remover" @click="openRemove({ motivoEstoqueMovimentacaoId: item.motivoEstoqueMovimentacaoId })">
        ...
        <b-modal centered v-model="dialogEdit" :hide-footer="true" title="Editar">
            <form-edit v-if="dialogEdit" :id="motivoEstoqueMovimentacaoId" @on-saved="onSaved()" @on-back="hideAll()" />
        </b-modal>
...
<script>
    ...
    export default {
        name: 'motivoestoquemovimentacao',
        mixins: [base],
        ...
        data() {
            return {
                ...
                resources: {
                    filter: 'motivoestoquemovimentacao',
                    remove: 'motivoestoquemovimentacao'
                },
        ...
        methods: {
            openEdit: function (model) {
                this.motivoEstoqueMovimentacaoId = model.motivoEstoqueMovimentacaoId;
