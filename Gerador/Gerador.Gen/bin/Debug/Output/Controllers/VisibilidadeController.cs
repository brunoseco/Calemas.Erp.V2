...
namespace superacrm.ui.Core.Api.Controllers
{
    ...
    public class VisibilidadeController : VisibilidadeControllerBase
    {
        public VisibilidadeController(VisibilidadeService service, VisibilidadeRepository rep, ILoggerFactory logger)
