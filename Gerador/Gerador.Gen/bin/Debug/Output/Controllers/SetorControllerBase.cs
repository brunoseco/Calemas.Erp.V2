...
{
    public class SetorControllerBase : Controller
    {
        protected readonly SetorService _service;
        protected readonly SetorRepository _rep;
        ...
        {
            var result = new HttpResult<SetorDto>(this._logger, this._service);
            try
            {
            ...
            {
                return result.ReturnCustomException(ex, "Setor", filters);
            }
        }
		...
		public async Task<IActionResult> Get(int id, [FromQuery]SetorFilter filters)
		{
			...
			{
				return result.ReturnCustomException(ex, "Setor", id);
			}
		}

        [HttpPost]
        public async Task<IActionResult> Post([FromBody]SetorDtoSave dto)
        {
            var result = new HttpResult<SetorDto>(this._logger, this._service);
            try
            {
            ...
            {
                return result.ReturnCustomException(ex, "Setor", dto);
            }
        }

        [HttpPut]
        public async Task<IActionResult> Put([FromBody]SetorDtoSave dto)
        {
            var result = new HttpResult<SetorDto>(this._logger, this._service);
            try
            {
        ...
        [HttpGet("DataItems")]
        public async Task<IActionResult> DataItems([FromQuery]SetorFilter filters)
        {
