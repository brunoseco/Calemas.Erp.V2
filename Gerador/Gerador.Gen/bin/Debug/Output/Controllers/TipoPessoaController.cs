...
namespace superacrm.ui.Core.Api.Controllers
{
    ...
    public class TipoPessoaController : TipoPessoaControllerBase
    {
        public TipoPessoaController(TipoPessoaService service, TipoPessoaRepository rep, ILoggerFactory logger)
