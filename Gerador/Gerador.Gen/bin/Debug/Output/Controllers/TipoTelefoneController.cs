...
namespace superacrm.ui.Core.Api.Controllers
{
    ...
    public class TipoTelefoneController : TipoTelefoneControllerBase
    {
        public TipoTelefoneController(TipoTelefoneService service, TipoTelefoneRepository rep, ILoggerFactory logger)
