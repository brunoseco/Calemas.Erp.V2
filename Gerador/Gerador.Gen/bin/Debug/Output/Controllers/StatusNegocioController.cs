...
namespace superacrm.ui.Core.Api.Controllers
{
    ...
    public class StatusNegocioController : StatusNegocioControllerBase
    {
        public StatusNegocioController(StatusNegocioService service, StatusNegocioRepository rep, ILoggerFactory logger)
