...
namespace superacrm.ui.Core.Api.Controllers
{
    ...
    public class TipoEnderecoController : TipoEnderecoControllerBase
    {
        public TipoEnderecoController(TipoEnderecoService service, TipoEnderecoRepository rep, ILoggerFactory logger)
