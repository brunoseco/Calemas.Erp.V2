...
namespace superacrm.ui.Core.Api.Controllers
{
    ...
    public class TipoEmailController : TipoEmailControllerBase
    {
        public TipoEmailController(TipoEmailService service, TipoEmailRepository rep, ILoggerFactory logger)
